...
These are **synthetic but schema-faithful** — written from the spec in docs/specs/03-jsonl-and-hooks.md §1. They MUST be re-validated against a real CC session before Wedge 3 (parser implementation) is signed off — see `tests/scripts/capture-real-jsonl.md`.
